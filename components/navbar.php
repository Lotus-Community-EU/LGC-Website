                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-lg-end">
                            <?php
                                ...
                                Functions::AddAdminTabLink('todo','/admin/todo/view','fa-solid fa-file-pen','admin_todo_access','To-Do System','TBA', [Functions::$webdev_role, Functions::$pl_role, Functions::$vpl_role, Functions::$bt_role]);
                            ?>
                        </ul>
                    </li>
                <?php } ?>
